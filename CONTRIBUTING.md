# Contributing to Algorand Node Companion App

👍🎉 First off, thanks for taking the time to contribute! 🎉👍

The following is a set of guidelines for contributing to Algorand Node Companion App.
...
By contributing to Algorand-Dart, you agree that your contributions will be licensed
